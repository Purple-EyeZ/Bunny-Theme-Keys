...
const BASE_URL =
	"https://raw.githubusercontent.com/Purple-EyeZ/Bunny-Theme-Keys/refs/heads/main/src/Templates/";
...
async function fetchTemplate(fileName) {
	try {
		...
		throw new Error(
			"Failed to fetch template. Please check your internet connection.",
		);
	}
}
...
async function showPreview(fileName) {
	const { previewContainer, previewOverlay, jsonPreview, downloadLink } =
		elements;
