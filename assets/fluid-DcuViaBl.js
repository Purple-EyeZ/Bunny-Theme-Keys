...
`),nr=h(i.FRAGMENT_SHADER,`
    ...
    }`,T.supportLinearFiltering?null:["MANUAL_FILTERING"]),ar=h(i.FRAGMENT_SHADER,`
    precision mediump float;
    precision mediump sampler2D;
...
`),f=(i.bindBuffer(i.ARRAY_BUFFER,i.createBuffer()),i.bufferData(i.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),i.STATIC_DRAW),i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,i.createBuffer()),i.bufferData(i.ELEMENT_ARRAY_BUFFER,new Uint16Array([0,1,2,0,2,3]),i.STATIC_DRAW),i.vertexAttribPointer(0,2,i.FLOAT,!1,0,0),i.enableVertexAttribArray(0),(e,t=!1)=>{e==null?(i.viewport(0,0,i.drawingBufferWidth,i.drawingBufferHeight),i.bindFramebuffer(i.FRAMEBUFFER,null)):(i.viewport(0,0,e.width,e.height),i.bindFramebuffer(i.FRAMEBUFFER,e.fbo)),t&&(i.clearColor(0,0,0,1),i.clear(i.COLOR_BUFFER_BIT)),i.drawElements(i.TRIANGLES,6,i.UNSIGNED_SHORT,0)});let E,d,de,me,w,pe,_=[],Q,je,Le=fr("../assets/LDR_LLL1_0.png");const Y=new I(Pt,Jt),De=new I(p,jt),ie=new I(p,Kt),we=new I(p,kt);new I(p,qt);const J=new I(p,$t),Z=new I(p,er),j=new I(p,tr),Ge=new I(p,rr),oe=new I(p,ir),D=new I(p,or),R=new I(p,nr),ne=new I(p,ar),ae=new I(p,cr),O=new I(p,sr),K=new I(p,lr),k=new I(p,ur),G=new Vt(p,Qt);function Ke(){let e=$(u.SIM_RESOLUTION),t=$(u.DYE_RESOLUTION);const r=T.halfFloatTexType,o=T.formatRGBA,n=T.formatRG,c=T.formatR,a=T.supportLinearFiltering?i.LINEAR:i.NEAREST;i.disable(i.BLEND),E==null?E=ce(t.width,t.height,o.internalFormat,o.format,r,a):E=Fe(E,t.width,t.height,o.internalFormat,o.format,r,a),d==null?d=ce(e.width,e.height,n.internalFormat,n.format,r,a):d=Fe(d,e.width,e.height,n.internalFormat,n.format,r,a),de=C(e.width,e.height,c.internalFormat,c.format,r,i.NEAREST),me=C(e.width,e.height,c.internalFormat,c.format,r,i.NEAREST),w=ce(e.width,e.height,c.internalFormat,c.format,r,i.NEAREST),dr(),mr()}function dr(){let e=$(u.BLOOM_RESOLUTION);const t=T.halfFloatTexType,r=T.formatRGBA,o=T.supportLinearFiltering?i.LINEAR:i.NEAREST;pe=C(e.width,e.height,r.internalFormat,r.format,t,o),_.length=0;for(let n=0;n<u.BLOOM_ITERATIONS;n++){let c=e.width>>n+1,a=e.height>>n+1;if(c<2||a<2)break;let s=C(c,a,r.internalFormat,r.format,t,o);_.push(s)}}function mr(){let e=$(u.SUNRAYS_RESOLUTION);const t=T.halfFloatTexType,r=T.formatR,o=T.supportLinearFiltering?i.LINEAR:i.NEAREST;Q=C(e.width,e.height,r.internalFormat,r.format,t,o),je=C(e.width,e.height,r.internalFormat,r.format,t,o)}function C(e,t,r,o,n,c){i.activeTexture(i.TEXTURE0);let a=i.createTexture();i.bindTexture(i.TEXTURE_2D,a),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,c),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,c),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),i.texImage2D(i.TEXTURE_2D,0,r,e,t,0,o,n,null);let s=i.createFramebuffer();i.bindFramebuffer(i.FRAMEBUFFER,s),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,a,0),i.viewport(0,0,e,t),i.clear(i.COLOR_BUFFER_BIT);let l=1/e,v=1/t;return{texture:a,fbo:s,width:e,height:t,texelSizeX:l,texelSizeY:v,attach(S){return i.activeTexture(i.TEXTURE0+S),i.bindTexture(i.TEXTURE_2D,a),S}}}function ce(e,t,r,o,n,c){let a=C(e,t,r,o,n,c),s=C(e,t,r,o,n,c);return{width:e,height:t,texelSizeX:a.texelSizeX,texelSizeY:a.texelSizeY,get read(){return a},set read(l){a=l},get write(){return s},set write(l){s=l},swap(){let l=a;a=s,s=l}}}function gr(e,t,r,o,n,c,a){let s=C(t,r,o,n,c,a);return De.bind(),i.uniform1i(De.uniforms.uTexture,e.attach(0)),f(s),s}function Fe(e,t,r,o,n,c,a){return e.width==t&&e.height==r||(e.read=gr(e.read,t,r,o,n,c,a),e.write=C(t,r,o,n,c,a),e.width=t,e.height=r,e.texelSizeX=1/t,e.texelSizeY=1/r),e}function fr(e){let t=i.createTexture();i.bindTexture(i.TEXTURE_2D,t),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.REPEAT),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.REPEAT),i.texImage2D(i.TEXTURE_2D,0,i.RGB,1,1,0,i.RGB,i.UNSIGNED_BYTE,new Uint8Array([255,255,255]));let r={texture:t,width:1,height:1,attach(n){return i.activeTexture(i.TEXTURE0+n),i.bindTexture(i.TEXTURE_2D,t),n}},o=new Image;return o.onload=()=>{r.width=o.width,r.height=o.height,i.bindTexture(i.TEXTURE_2D,t),i.texImage2D(i.TEXTURE_2D,0,i.RGB,i.RGB,i.UNSIGNED_BYTE,o)},o.src=e,r}function vr(){let e=[];u.SHADING&&e.push("SHADING"),u.BLOOM&&e.push("BLOOM"),u.SUNRAYS&&e.push("SUNRAYS"),G.setKeywords(e)}vr();Ke();Qe(parseInt(Math.random()*20)+5);let _e=Date.now();ke();function ke(){const e=hr();qe()&&Ke(),Ir(),pr(e),Er(null),requestAnimationFrame(ke)}function hr(){let e=Date.now(),t=(e-_e)/1e3;return t=Math.min(t,.016666),_e=e,t}function qe(){if(!g)return;let e=A(g.clientWidth),t=A(g.clientHeight);return g.width!=e||g.height!=t?(g.width=e,g.height=t,!0):!1}function Ir(){Be.length>0&&Qe(Be.pop()),x.forEach(e=>{e.moved&&(e.moved=!1,Rr(e))})}function pr(e){i.disable(i.BLEND),ae.bind(),i.uniform2f(ae.uniforms.texelSize,d.texelSizeX,d.texelSizeY),i.uniform1i(ae.uniforms.uVelocity,d.read.attach(0)),f(me),O.bind(),i.uniform2f(O.uniforms.texelSize,d.texelSizeX,d.texelSizeY),i.uniform1i(O.uniforms.uVelocity,d.read.attach(0)),i.uniform1i(O.uniforms.uCurl,me.attach(1)),i.uniform1f(O.uniforms.curl,u.CURL),i.uniform1f(O.uniforms.dt,e),f(d.write),d.swap(),ne.bind(),i.uniform2f(ne.uniforms.texelSize,d.texelSizeX,d.texelSizeY),i.uniform1i(ne.uniforms.uVelocity,d.read.attach(0)),f(de),ie.bind(),i.uniform1i(ie.uniforms.uTexture,w.read.attach(0)),i.uniform1f(ie.uniforms.value,u.PRESSURE),f(w.write),w.swap(),K.bind(),i.uniform2f(K.uniforms.texelSize,d.texelSizeX,d.texelSizeY),i.uniform1i(K.uniforms.uDivergence,de.attach(0));for(let r=0;r<u.PRESSURE_ITERATIONS;r++)i.uniform1i(K.uniforms.uPressure,w.read.attach(1)),f(w.write),w.swap();k.bind(),i.uniform2f(k.uniforms.texelSize,d.texelSizeX,d.texelSizeY),i.uniform1i(k.uniforms.uPressure,w.read.attach(0)),i.uniform1i(k.uniforms.uVelocity,d.read.attach(1)),f(d.write),d.swap(),R.bind(),i.uniform2f(R.uniforms.texelSize,d.texelSizeX,d.texelSizeY),T.supportLinearFiltering||i.uniform2f(R.uniforms.dyeTexelSize,d.texelSizeX,d.texelSizeY);let t=d.read.attach(0);i.uniform1i(R.uniforms.uVelocity,t),i.uniform1i(R.uniforms.uSource,t),i.uniform1f(R.uniforms.dt,e),i.uniform1f(R.uniforms.dissipation,u.VELOCITY_DISSIPATION),f(d.write),d.swap(),T.supportLinearFiltering||i.uniform2f(R.uniforms.dyeTexelSize,E.texelSizeX,E.texelSizeY),i.uniform1i(R.uniforms.uVelocity,d.read.attach(0)),i.uniform1i(R.uniforms.uSource,E.read.attach(1)),i.uniform1f(R.uniforms.dissipation,u.DENSITY_DISSIPATION),f(E.write),E.swap()}function Er(e){u.BLOOM&&yr(E.read,pe),u.SUNRAYS&&(xr(E.read,E.write,Q),br(Q,je,1)),i.blendFunc(i.ONE,i.ONE_MINUS_SRC_ALPHA),i.enable(i.BLEND),Sr(e,Lr(u.BACK_COLOR)),Tr(e)}function Sr(e,t){we.bind(),i.uniform4f(we.uniforms.color,t.r,t.g,t.b,1),f(e)}function Tr(e){let t=i.drawingBufferWidth,r=i.drawingBufferHeight;if(G.bind(),u.SHADING&&i.uniform2f(G.uniforms.texelSize,1/t,1/r),i.uniform1i(G.uniforms.uTexture,E.read.attach(0)),u.BLOOM){i.uniform1i(G.uniforms.uBloom,pe.attach(1)),i.uniform1i(G.uniforms.uDithering,Le.attach(2));let o=Dr(Le,t,r);i.uniform2f(G.uniforms.ditherScale,o.x,o.y)}u.SUNRAYS&&i.uniform1i(G.uniforms.uSunrays,Q.attach(3)),f(e)}function yr(e,t){if(_.length<2)return;let r=t;i.disable(i.BLEND),J.bind();let o=u.BLOOM_THRESHOLD*u.BLOOM_SOFT_KNEE+1e-4,n=u.BLOOM_THRESHOLD-o,c=o*2,a=.25/o;i.uniform3f(J.uniforms.curve,n,c,a),i.uniform1f(J.uniforms.threshold,u.BLOOM_THRESHOLD),i.uniform1i(J.uniforms.uTexture,e.attach(0)),f(r),Z.bind();for(let s=0;s<_.length;s++){let l=_[s];i.uniform2f(Z.uniforms.texelSize,r.texelSizeX,r.texelSizeY),i.uniform1i(Z.uniforms.uTexture,r.attach(0)),f(l),r=l}i.blendFunc(i.ONE,i.ONE),i.enable(i.BLEND);for(let s=_.length-2;s>=0;s--){let l=_[s];i.uniform2f(Z.uniforms.texelSize,r.texelSizeX,r.texelSizeY),i.uniform1i(Z.uniforms.uTexture,r.attach(0)),i.viewport(0,0,l.width,l.height),f(l),r=l}i.disable(i.BLEND),j.bind(),i.uniform2f(j.uniforms.texelSize,r.texelSizeX,r.texelSizeY),i.uniform1i(j.uniforms.uTexture,r.attach(0)),i.uniform1f(j.uniforms.intensity,u.BLOOM_INTENSITY),f(t)}function xr(e,t,r){i.disable(i.BLEND),Ge.bind(),i.uniform1i(Ge.uniforms.uTexture,e.attach(0)),f(t),oe.bind(),i.uniform1f(oe.uniforms.weight,u.SUNRAYS_WEIGHT),i.uniform1i(oe.uniforms.uTexture,t.attach(0)),f(r)}function br(e,t,r){Y.bind();for(let o=0;o<r;o++)i.uniform2f(Y.uniforms.texelSize,e.texelSizeX,0),i.uniform1i(Y.uniforms.uTexture,e.attach(0)),f(t),i.uniform2f(Y.uniforms.texelSize,0,e.texelSizeY),i.uniform1i(Y.uniforms.uTexture,t.attach(0)),f(e)}function Rr(e){let t=e.deltaX*u.SPLAT_FORCE,r=e.deltaY*u.SPLAT_FORCE;$e(e.texcoordX,e.texcoordY,t,r,e.color)}function Qe(e){for(let t=0;t<e;t++){const r=Ee();r.r*=10,r.g*=10,r.b*=10;const o=Math.random(),n=Math.random(),c=1e3*(Math.random()-.5),a=1e3*(Math.random()-.5);$e(o,n,c,a,r)}}function $e(e,t,r,o,n){D.bind(),i.uniform1i(D.uniforms.uTarget,d.read.attach(0)),i.uniform1f(D.uniforms.aspectRatio,g.width/g.height),i.uniform2f(D.uniforms.point,e,t),i.uniform3f(D.uniforms.color,r,o,0),i.uniform1f(D.uniforms.radius,Cr(u.SPLAT_RADIUS/100)),f(d.write),d.swap(),i.uniform1i(D.uniforms.uTarget,E.read.attach(0)),i.uniform3f(D.uniforms.color,n.r,n.g,n.b),f(E.write),E.swap()}function Cr(e){let t=g.width/g.height;return t>1&&(e*=t),e}g.addEventListener("mousedown",e=>{let t=A(e.offsetX),r=A(e.offsetY),o=x.find(n=>n.id==-1);o==null&&(o=new ee,x.push(o)),et(o,-1,t,r)});window.addEventListener("mousemove",e=>{let t=A(e.clientX),r=A(e.clientY),o=x[0];o||(o=new ee,x.push(o)),tt(o,t,r)});window.addEventListener("mouseup",()=>{rt(x[0])});window.addEventListener("touchstart",e=>{e.target===g&&e.preventDefault();const t=e.targetTouches;for(;t.length>=x.length;)x.push(new ee);for(let r=0;r<t.length;r++){let o=A(t[r].pageX),n=A(t[r].pageY-window.scrollY);et(x[r+1],t[r].identifier,o,n)}},{passive:!1});window.addEventListener("touchmove",e=>{e.target===g&&e.preventDefault();const t=e.targetTouches;for(let r=0;r<t.length;r++){let o=x[r+1];if(!o.down)continue;let n=A(t[r].pageX),c=A(t[r].pageY-window.scrollY);tt(o,n,c)}},{passive:!1});window.addEventListener("touchend",e=>{const t=e.changedTouches;for(let r=0;r<t.length;r++){let o=x.find(n=>n.id==t[r].identifier);o!=null&&rt(o)}});function et(e,t,r,o){e.id=t,e.down=!0,e.moved=!1,e.texcoordX=r/g.width,e.texcoordY=1-o/g.height,e.prevTexcoordX=e.texcoordX,e.prevTexcoordY=e.texcoordY,e.deltaX=0,e.deltaY=0,e.color=Ee()}function tt(e,t,r){e.prevTexcoordX=e.texcoordX,e.prevTexcoordY=e.texcoordY,e.texcoordX=t/g.width,e.texcoordY=1-r/g.height,e.deltaX=Ar(e.texcoordX-e.prevTexcoordX),e.deltaY=Br(e.texcoordY-e.prevTexcoordY),e.moved=Math.abs(e.deltaX)>0||Math.abs(e.deltaY)>0,e.moved&&(e.color=Ee())}function rt(e){e.down=!1}function Ar(e){let t=g.width/g.height;return t<1&&(e*=t),e}function Br(e){let t=g.width/g.height;return t>1&&(e/=t),e}function Ee(){return{r:u.FIXED_COLOR.r,g:u.FIXED_COLOR.g,b:u.FIXED_COLOR.b}}function Lr(e){return{r:e.r/255,g:e.g/255,b:e.b/255}}function $(e){let t=i.drawingBufferWidth/i.drawingBufferHeight;t<1&&(t=1/t);let r=Math.round(e),o=Math.round(e*t);return i.drawingBufferWidth>i.drawingBufferHeight?{width:o,height:r}:{width:r,height:o}}function Dr(e,t,r){return{x:t/e.width,y:r/e.height}}function A(e){let t=window.devicePixelRatio||1;return Math.floor(e*t)}function wr(e){if(e.length==0)return 0;let t=0;for(let r=0;r<e.length;r++)t=(t<<5)-t+e.charCodeAt(r),t|=0;return t}export{Gr as s};
